...
const int rs = 12, en = 9, d4 = 7, d5 = 4, d6 = 3, d7 = 2;
...
bool fan = false;							// light is OFF (false) or ON (true)
...
void setup() {
	...
	if (EEPROM.read(0) == 255) {
		...
		EEPROM.write(2, 65);    // Humidity
		EEPROM.write(3, true);  // light
...
void updateFan(){
	...
	byte buttonState = digitalRead(buttonFan);
...
/*
 * turn the fan OFF and print the state of fan
 */ 
